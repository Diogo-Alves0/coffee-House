            ...
            <div class="col-md-10 col-lg-7 col-xl-6">
              ...
              <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-4">
                ...
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-4-3" data-toggle="tab">Satisfa ção ao cliente.</a></li>
                </ul>
                <!-- Tab panes-->
      ...
      <section class="section context-dark">
        <div class="parallax-container" data-parallax-img="images/bg-parallax-2.jpg">
          <div class="parallax-content section-md bg-overlay-2-21">
            <div class="container">
              <div class="oh">
                <h2 class="wow slideInUp" data-wow-delay="0s">Comentarios</h2>
              </div>
              <!-- Owl Carousel-->
