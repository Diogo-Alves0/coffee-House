...
<head>
  ...
  <meta nome+="description" content="Cafeteria bebidas doces e salgados, São paulo">
  <meta nome="autor" content="Coffee House">
        ...
        <div class="rd-navbar-wrap rd-navbar-modern-wrap">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a title="Ir para pagina inicial" class="brand" href="index.php"><img src="images/logo-default-196x47.png" alt="" width="196" height="47"/></a></div>
                </div>
                      ...
                      <div class="cart-inline">
                        <div class="cart-inline-header">
                          ...
                          <span class="dados-usuarios">
                            <p><a href="dados-editar"  title="Editar Dados" >
                       ...
                       <div class="cart-inline-body">
                        <div class="cart-inline-item">
                          <div class="unit align-items-center">
                            ...
                            <div class="unit-body">
                              <h6 class="cart-inline-name"><a href="#">Valor Produto </a></h6>
                              <div>
          ...
          <div class="rd-navbar-project rd-navbar-modern-project">
            ...
            <div class="rd-navbar-project-content rd-navbar-modern-project-content">
              <div>
                <p>Siga-nos em nossas redes sociais e fique por dentro das promoções, participe para ganhar premios e grandes descontos !!</p>

                <ul class="rd-navbar-modern-contacts">
                  <li>
                    <div class="unit unit-spacing-sm">
                      <div class="unit-left"><span class="icon fa fa-phone"></span></div>
                      <div class="unit-body"><a target="_blank" class="link-phone" href="http://api.whatsapp.com/send?1+pt_BR&phone=5511932302728">11 3455-4688</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-sm">
                      <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                      <div class="unit-body"><a class="link-location" href="#">Av. Brigadeiro faria lima, 750, São Paulo</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-sm">
          ...
          <form method="post">
            <div class="row">
              <div class="col-md-4">
                ...
                $res_dado = $pdo->query("SELECT * from locais where nome = '$nome'");
